...
namespace MagicHamster.GrocerySamurai.DataAccess.UnitTest.EntityTests
{
    public class StoreItemRepositoryTest : EntityRepositoryTest<StoreItem>
    {
        ...
        [Test]
        public void GetById_StoreItem_Test()
        {
            get_ById_TestHelper();
        }

        [Test]
        public void GetByCriteria_All_StoreItem_Test()
        {
            get_ByCriteria_All_TestHelper();
        }

        [Test]
        public void GetByCriteria_Single_StoreItem_Test()
        {
            get_ByCriteria_Single_TestHelper();
        }

        [Test]
        public void Add_ByEntity_StoreItem_Test()
        {
            add_ByEntity_TestHelper();
        }

        [Test]
        public void Add_ByEntities_StoreItem_Test()
        {
            add_ByEntities_TestHelper();
        }

        [Test]
        public void Update_ByEntity_StoreItem_Test()
        {
            update_ByEntity_TestHelper();
        }

        [Test]
        public void Update_ById_StoreItem_Test()
        {
            update_ById_TestHelper();
        }

        [Test]
        public void Update_ByEntities_StoreItem_Test()
        {
            update_ByEntities_TestHelper();
        }

        [Test]
        public void Update_ByCriteria_StoreItem_Test()
        {
            update_ByCriteria_TestHelper();
        }

        [Test]
        public void Delete_ByEntity_StoreItem_Test()
        {
            delete_ByEntity_TestHelper();
        }

        [Test]
        public void Delete_ById_StoreItem_Test()
        {
            delete_ById_TestHelper();
        }

        [Test]
        public void Delete_ByEntities_StoreItem_Test()
        {
            delete_ByEntities_TestHelper();
        }

        [Test]
        public void Delete_ByCriteria_StoreItem_Test()
        {
